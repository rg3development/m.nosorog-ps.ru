...
<div id="content">
    <form action="<?= base_url("admin/banner/edit/{$data['id']}/{$parent_id}"); ?>" method="post">
        <table class="admin_module_form banners_module_edit">
            ...
            <tr>
                ...
                <td><input type="text" name="title" value='<?= set_value('title', $data['title']); ?>'/></td>
            </tr>
            <tr>
                <td class="admin_module_form_title">активных баннеров</td>
                <td><input type="text" name="count_per_page" value='<?= set_value('count_per_page', $data['count_per_page']); ?>'/></td>
            </tr>
            <tr>
                <td class="admin_module_form_title">ширина изображения</td>
                <td><input type="text" name="resize_width" value='<?= set_value('resize_width', $data['resize_width']); ?>'/></td>
            </tr>
            <tr>
                <td class="admin_module_form_title">высота изображения</td>
                <td><input type="text" name="resize_height" value='<?= set_value('resize_height', $data['resize_height']); ?>'/></td>
            </tr>
            <tr>
                <td class="admin_module_form_title"></td>
