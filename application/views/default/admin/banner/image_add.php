...
<div id="content">
    <form action="<?= base_url("admin/banner/add_image/{$parent_id}"); ?>" method="post" enctype="multipart/form-data">
        <table class="admin_module_form">
            ...
            <tr>
                <td class="admin_module_form_title">название</td><td><input type="text" name="title" value='1' /></td>
            </tr>
            <tr>
                <td class="admin_module_form_title">ссылка</td><td><input type="text" name="link" value='' /></td>
            </tr>
            <tr>
                <td class="admin_module_form_title">открывать в новой вкладке</td><td><input type="checkbox" name="link_new_window[]" value='' /></td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="admin_module_form_title">изображение</td><td><input type="file" name="image" size="255" />&nbsp;<strong><?= BANNER_MAIN_IMAGE_TOOLTIP; ?></strong></td>
            </tr>
            <tr>
                <td class="admin_module_form_title">текст</td><td><textarea class="ckeditor" id="description" name="description"><?=$this->input->post('description');?></textarea></td>
            </tr>
            <tr>
