        ...
        <form action="<?=base_url('admin/map/add');?>" method="post" enctype="multipart/form-data">
            <table class="admin_module_form" class="admin_module_map_edit">
                ...
                <tr>
                    ...
                    <td><input type="text" name="alias" value='<?=$this->input->post('alias');?>' /></td>
                </tr>
                <tr>
                    <td class="admin_module_form_title">показывать псевдоним</td>
                    <td><input type="checkbox" name="show_alias" class="admin_module_form_checkbox styled" /></td>
                </tr>
                <tr><td class="admin_module_form_title">url</td><td><input type="text" name="url" value='<?=$this->input->post('url');?>' /></td></tr>
                <tr>
                    <td class="admin_module_form_title">порядок</td>
                    <td>
                        <input type="text" name="priority" value='<?=$this->input->post('priority');?>' />
                    </td>
                </tr>
                ...
                <tr><td class="admin_module_form_title">показывать</td><td><input type="checkbox" name="show" class="admin_module_form_checkbox styled" <?=!empty($_POST['show']) && $_POST['show'] == 'on' ? 'checked' : '';?> /></td></tr>
                <tr>
