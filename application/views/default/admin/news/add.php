...
<div id="content">
    <form action="<?=base_url("admin/news/add/{$parent_id}");?>" method="post">
        <table class="admin_module_form">
            ...
            <tr><td class="admin_module_form_title">включить rss</td><td><input type="checkbox" name="rss" class="admin_module_form_checkbox styled" <?=$this->input->post('rss') == 'on' ? 'checked' : '';?> /></td></tr>
