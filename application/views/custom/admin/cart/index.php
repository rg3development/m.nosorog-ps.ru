                ...
                <li class="no_bg list_li">
                    <div class="menuline clearfix">
                        <span class="left" title="Номер заказа">
                            ...
                            <strong>заказчик:</strong><?= $order_item['order']->fename; ?> <?= $order_item['order']->name; ?> |
                    ...
                    <div class="clearfix">
                        <ul class="admin_list">
                            <li class="no_bg">
                                <div class="menuline clearfix">
                                    <span class="left">
                                        ...
                                        <strong>адрес:</strong> <?= $order_item['order']->address; ?></br>
                                        <strong></strong>
                                    </span>
                                </div>
                            </li>
                            <li class="no_bg">
                                <div class="menuline clearfix">
                                    <span class="left">
                                        <strong>доставка:</strong> <?= $this->cart_mapper->_com_method($order_item['order']->comments); ?>
                                    </span>
                                </div>
                            </li>
                            <li class="no_bg">
                                ...
                                <li>
                                    <div class="menuline clearfix">
                                        ...
                                        <span class="left" title="Дата заказа">
                                            ...
                                            |<?= $item['cart']->qty; ?> шт. | <?= $item['cart']->base_price; ?> руб.| Размер:  <?=$item['cart']->size;?>
                                        </span>
                                    </div>
                                </li>
                            <? endforeach; ?>
