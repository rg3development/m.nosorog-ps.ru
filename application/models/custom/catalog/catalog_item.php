...
class Catalog_Item extends MY_Model_Catalog
{
    ...
    public function img_src ( $img_obj, $full_url = FALSE )
    {
        ...
        if ( $img_obj && $img_obj->image_id )
        {
            ...
            if ( $full_url )
            {
                $image_src = base_url('http://nosorog-ps.ru' . $image->getFilename());
            } else {
                $image_src = 'http://nosorog-ps.ru' . $image->getFilename();
            }
        }
        return $image_src;
    }
    ...
    {
        return $this->cart->format_number($this->price) ;
    }
    ...
    public function price_discount()
    {
        ...
        return $this->cart->format_number($price_discount) ;
    }
    ...
    public function add_to_cart ()
    {
        ...
        <input name="size2" value="L" type="hidden"/>
        </form>
        ';
        print($form);
    }
