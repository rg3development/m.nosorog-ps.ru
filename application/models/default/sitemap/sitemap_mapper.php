...
class Sitemap_mapper extends MY_Model
{
    ...
    public function  __construct()
    {
        ...
        $this->_template['sitemap_xml'] = 'sitemap/sitemap_xml';
    }
    ...
    {
        $xml_sitemap = $this->page_mapper->get_allshow_pages();

        $data['sitemap_xml'] = $xml_sitemap;
        return $this->load->site_view($this->_template['sitemap_xml'], $data, TRUE);
    }
